...
const string LoginRegister = "LoginRegister.txt";
...
private:
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        LoginRegisterRecord.DateLTime = LoginRegisterDataLine[0];
...
public:
    ...
    static vector <stLoginRegisterRecord> GetLoginRegisterList()
    {
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                stLogin = _ConvertLoginRegisterLineToRecord(Line);
                vLogin.push_back(stLogin);
            }
        }
        return vLogin;
    }
